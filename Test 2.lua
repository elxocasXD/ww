loadstring(game:HttpGet("https://raw.githubusercontent.com/elxocasXD/scripts/main/Gui.lua"))()

if getgenv().UI_Library_Premium_Enable == true then
	getgenv().Library_Premium_Name = "Trip Hub Premiun"
local Kavo = {}
...
Purple = {
SchemeColor = Color3.fromRGB(106,106,255,255), --section
    Background = Color3.fromRGB(20,20,20), --fondo
    Header = Color3.fromRGB(25,23,26,255), --tabs
    TextColor = Color3.fromRGB(215,215,215), --text
    ElementColor = Color3.fromRGB(24,24,24,255) --buttons
    },

Beautifull = {
SchemeColor = Color3.fromRGB(140,206,100), --section
    Background = Color3.fromRGB(49,49,59), --fondo
    Header = Color3.fromRGB(40,40,48), --tabs
    TextColor = Color3.fromRGB(255,255,255), --text
    ElementColor = Color3.fromRGB(40,40,48) --buttons
    },

Sky = {
SchemeColor = Color3.fromRGB(140,206,255), --section
    Background = Color3.fromRGB(49,49,59), --fondo
    Header = Color3.fromRGB(40,40,48), --tabs
    TextColor = Color3.fromRGB(255,255,255), --text
    ElementColor = Color3.fromRGB(40,40,48) --buttons
...
Brick = {
SchemeColor = Color3.fromRGB(251,111,83,255), --section
    Background = Color3.fromRGB(45,48,53,255), --fondo
    Header = Color3.fromRGB(35,38,43,255), --tabs
    TextColor = Color3.fromRGB(255,255,255), --text
    ElementColor = Color3.fromRGB(40,40,48,255) --buttons
    },

Turquoise = {
SchemeColor = Color3.fromRGB(0,170,126), --section
    Background = Color3.fromRGB(35,36,41), --fondo
    Header = Color3.fromRGB(52,52,62), --tabs
    TextColor = Color3.fromRGB(255,255,255), --text
    ElementColor = Color3.fromRGB(40,40,48,255) --buttons
    },

OperaGx = {
SchemeColor = Color3.fromRGB(179,0,67,255), --section
    Background = Color3.fromRGB(33,35,47), --fondo
    Header = Color3.fromRGB(30,30,45), --tabs
    TextColor = Color3.fromRGB(255,255,255), --text
    ElementColor = Color3.fromRGB(30,30,38) --buttons
    }
}
...
local LibName = getgenv().Library_Premium_Name "Trip Hub Premiun"
...
elseif themeList == "Gamer" then
        themeList = themeStyles.Gamer
elseif themeList == "DarkV2" then
        themeList = themeStyles.DarkV2
elseif themeList == "Twitch" then
        themeList = themeStyles.Twitch
elseif themeList == "Water" then
        themeList = themeStyles.Water
...
elseif themeList == "Beautifull" then
        themeList = themeStyles.Beautifull
elseif themeList == "Sky" then
        themeList = themeStyles.Sky
elseif themeList == "Brick" then
        themeList = themeStyles.Brick
elseif themeList == "Turquoise" then
        themeList = themeStyles.Turquoise
elseif themeList == "OperaGx" then
        themeList = themeStyles.OperaGx									
    else
   ...
   -- Kavo:DraggingEnabled(MainHeader, Main)
    ...
    blurFrame.Size = UDim2.new(0, 410, 0, 289)
    ...
    Main.Size = UDim2.new(0, 610, 0, 359)
    Main.Visible = true


local FrameW = Instance.new("Frame")
local UICorner = Instance.new("UICorner")

FrameW.Parent = game.CoreGui[LibName]
FrameW.BackgroundColor3 = themeList.Header
FrameW.BackgroundTransparency = 1.00
FrameW.Position = UDim2.new(0.538583934, 0, 0.182044894, 0)
FrameW.Size = UDim2.new(0, 120, 0, 120)
FrameW.Visible = false

local ImageButtonx = Instance.new("ImageButton")
ImageButtonx.Parent = FrameW
ImageButtonx.BackgroundColor3 = themeList.Header
ImageButtonx.BackgroundTransparency = 0.000
ImageButtonx.Position = UDim2.new(0.13, 0, 0.1, 0)
ImageButtonx.Size = UDim2.new(0, 100, 0, 100)
ImageButtonx.Image = "http://www.roblox.com/asset/?id=12756283803"
ImageButtonx.Active = true
ImageButtonx.Draggable = true
ImageButtonx.MouseButton1Click:Connect(function()
game.CoreGui[LibName].Main.Visible = true
game.CoreGui[LibName].Frame.Visible = false
		end)


UICorner.CornerRadius = UDim.new(0, 20)
UICorner.Parent = ImageButtonx
...
game:GetService("Players").PlayerAdded:connect(function(plr)
    ...
    MainHeader.Size = UDim2.new(0, 610, 0, 40)
...
local Logo = Instance.new("ImageLabel")
    ...
    Logo.Position = UDim2.new(0, 320, 0, -5)
    Logo.Size = UDim2.new(0, 50, 0, 50)
    Logo.Image = "http://www.roblox.com/asset/?id=12756283803"
    ...
    title.Position = UDim2.new(0.0171428565, 0, 0, 15)
    title.Size = UDim2.new(0, 205, 0, 10)
    ...
    close.Position = UDim2.new(0.949999988, 0, 0.2, 0)
...
game.CoreGui[LibName].Frame.Visible = true
    ...
    MainSide.Position = UDim2.new(-7.4505806e-09, 0, 0, 40)
    MainSide.Size = UDim2.new(0, 180, 0, 326)
--158
    ...
    tabFrames.Size = UDim2.new(0, 180, 0, 310)
	tabFrames.BorderColor3 = themeList.Header
    tabFrames.ScrollBarImageColor3 = themeList.SchemeColor
	tabFrames.ScrollBarThickness = 5

        local function UpdateSize()
            local cS = tabListing.AbsoluteContentSize
            game.TweenService:Create(tabFrames, TweenInfo.new(0.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {CanvasSize = UDim2.new(0,cS.X,0,cS.Y * 1.1)}):Play()
        end

        UpdateSize()
        tabFrames.ChildAdded:Connect(UpdateSize)
        tabFrames.ChildRemoved:Connect(UpdateSize)
    ...
    pages.Position = UDim2.new(0.33, 0, 0.13, 0)
    pages.Size = UDim2.new(0, 500, 0, 309)
    ...
    infoContainer.Size = UDim2.new(0, 380, 0, 50)
    ...
    function Tabs:NewTab(tabName)
        ...
        local function UpdateSize()
            ...
            game.TweenService:Create(page, TweenInfo.new(0.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {CanvasSize = UDim2.new(0,cS.X,0,cS.Y * 1.015)}):Play()
        end
        ...
        page.Size = UDim2.new(0, 395, 1, 0)
        page.ScrollBarThickness = 5
        page.Visible = false
        page.ScrollBarImageColor3 = themeList.Background
        ...
        tabButton.Size = UDim2.new(0, 165, 0, 28)
	...
	local NewSearchIcon = Instance.new("ImageLabel")
	NewSearchIcon.Name = "SearchIcon"
	NewSearchIcon.BackgroundTransparency = 4
	NewSearchIcon.Image = "http://www.roblox.com/asset/?id=3926305904"
	...
	local NewRoundBox = Instance.new("ImageLabel")
	NewRoundBox.BackgroundTransparency = 5
	NewRoundBox.Image = "http://www.roblox.com/asset/?id=3570695787"
...
local NewTextBoxx = Instance.new("TextBox")
	...
	NewTextBoxx.Size = UDim2.new(0,300,1,0)
	NewTextBoxx.ZIndex = 1
		...
		sectionHead.Visible = true
            ...
            sectionHead.Size = UDim2.new(0, 383, 0, 33)
        ...
        coroutine.wrap(function()
            ...
            local function updateSectionFrame()
                ...
                sectionFrame.Size = UDim2.new(0, 388, 0, frameSc.Y)
            end
                updateSectionFrame()
                UpdateSize()
            local Elements = {}
            function Elements:NewButton(bname,tipINf, callback)
                ...
                buttonElement.Size = UDim2.new(0, 382, 0, 33)
                ...
                moreInfo.Position = UDim2.new(0, 0, 50, 20)
                moreInfo.Size = UDim2.new(0, 430, 0, 33)
                moreInfo.ZIndex = 9
            ...
            function Elements:NewTextBox(tname, tTip, callback)
                ...
                textboxElement.Size = UDim2.new(0, 382, 0, 33)
                ...
                function Elements:NewToggle(tname, nTip, callback)
                    ...
                    toggleElement.Size = UDim2.new(0, 382, 0, 33)
            ...
            function Elements:NewSlider(slidInf, slidTip, maxvalue, minvalue, callback)
                ...
                sliderElement.Size = UDim2.new(0, 382, 0, 33)
            ...
            function Elements:NewDropdown(dropname, dropinf, list, callback)
                ...
                dropFrame.Size = UDim2.new(0, 382, 0, 33)
                ...
                dropOpen.Size = UDim2.new(0, 382, 0, 33)
                ...
                dropOpen.MouseButton1Click:Connect(function()
                    if not focusing then
                        if opened then
                            opened = false
                            dropFrame:TweenSize(UDim2.new(0, 382, 0, 33), "InOut", "Linear", 0.08)
                            wait(0.1)
                            updateSectionFrame()
                            UpdateSize()
                            local c = sample:Clone()
                            ...
                            opened = true
                            dropFrame:TweenSize(UDim2.new(0, 382, 0, UIListLayout.AbsoluteContentSize.Y), "InOut", "Linear", 0.08, true)
                            wait(0.1)
                            updateSectionFrame()
                            UpdateSize()
                            local c = sample:Clone()
                ...
                for i,v in next, list do
                    ...
                    optionSelect.Size = UDim2.new(0, 382, 0, 33)
            ...
            function Elements:NewKeybind(keytext, keyinf, first, callback)
                ...
                keybindElement.Size = UDim2.new(0, 382, 0, 33)
            ...
            function Elements:NewColorPicker(colText, colInf, defcolor, callback)
                ...
                colorElement.Size = UDim2.new(0, 382, 0, 33)
                ...
                colorElement.MouseButton1Click:Connect(function()
                    if not focusing then
                        if colorOpened then
                            colorOpened = false
                            colorElement:TweenSize(UDim2.new(0, 382, 0, 33), "InOut", "Linear", 0.08)
                            wait(0.1)
                            updateSectionFrame()
                            UpdateSize()
                            local c = sample:Clone()
                            ...
                            colorOpened = true
                            colorElement:TweenSize(UDim2.new(0, 382, 0, 141), "InOut", "Linear", 0.08, true)
                            wait(0.1)
                            updateSectionFrame()
                            UpdateSize()
                            local c = sample:Clone()
                ...
                colorHeader.Size = UDim2.new(0, 382, 0, 33)
                ...
                colorInners.Size = UDim2.new(0, 382, 0, 105)
            ...
            function Elements:NewLabel(title)
            	...
            	label.Text = title
           		label.Size = UDim2.new(0, 382, 0, 33)
